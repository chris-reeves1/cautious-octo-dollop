...
# Healthchecks - we can do health checks internally - this is just an FYI:
# add a /health route to app.py:
    # @app.route('/health')
    # def health():
    #     return 'OK', 200
# then we can use this to mark the container unhealthy (can see this in inspect):
